...
export function StatsGrid() {
    ...
    return (_jsx("div", { className: "grid grid-cols-[auto_1fr] gap-x-4 gap-y-1 p-3 text-sm", children: rows.map(([k, v]) => (_jsxs("button", { className: "contents text-left hover:opacity-80", onClick: () => copy(v), title: "Click to copy", children: [_jsx("span", { className: "text-slate-400", children: k }), _jsx("span", { className: "font-mono text-slate-100", children: v })] }, k))) }));
}
