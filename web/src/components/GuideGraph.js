...
export function GuideGraph() {
    ...
    if (!data) {
        return _jsx("div", { className: "flex h-full items-center justify-center text-slate-500", children: "Select a guiding section." });
    }
    const layout = {
        autosize: true,
    ...
    return (_jsx(Plot, { data: data.traces, layout: layout, config: { displaylogo: false, responsive: true, scrollZoom: true }, style: { width: '100%', height: '100%' }, useResizeHandler: true }));
}
